...
**Complete Field List:**
See `data/data_types.csv` for all 43 fields including:
...
- `data/data_types.csv` is now the single source of truth for field definitions
...
1. **Data Types Loader Module** (`ct_to_timesketch/core/data_types.py`)
   - Loads field definitions from `data/data_types.csv`
